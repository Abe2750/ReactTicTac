...
- Added a toggle to sort moves in ascending and descending order
- Winning three squares are highlighted
- Grid location is indicated in (row,col) format in move history
- Current move button is replaced by text
